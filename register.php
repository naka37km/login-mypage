        ...
        <form action="register_confirm.php" method="post" enctype="multipart/form-data">
            <div class="form_contents">
                ...
                <div class="mail">
                    ...
                    <input type="text" class="formbox" name="mail" size="40" pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" required>
                </div>
                ...
                <div class="password">
                    ...
                    <input type="password" class="formbox" name="confirm_password" size="40" id="confirm" oninput="ConfirmPassword(this)" required>
                </div>
